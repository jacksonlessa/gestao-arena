...
## Referências de caminhos (raiz do repositório)

- Comando de invocação: `ia-docs/commands/criar-tarefas.md`
- Template da lista de tarefas: `ia-docs/templates/tasks-template.md`
- Template de cada tarefa individual: `ia-docs/templates/task-template.md`
- Pasta da funcionalidade (`$ARGUMENTS` = slug, mesma pasta do PRD/Tech Spec): `tasks/$ARGUMENTS/`
...
Grave `tasks.md` e os arquivos `<num>_task.md` em `tasks/$ARGUMENTS/`. Use os templates em `ia-docs/templates/` (ver **Referências de caminhos**).
