...
- Comando de invocação: `ia-docs/commands/criar-techspec.md`
- Template Tech Spec: `ia-docs/templates/techspec-template.md`
- PRD requerido (entrada): `tasks/prd-[nome-funcionalidade]/prd.md`
...
- Usar `ia-docs/templates/techspec-template.md` como estrutura exata
